                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center gap-4">
                        <h1 className="text-2xl font-bold flex items-center gap-2 text-light-text-primary dark:text-dark-text-primary">
                            ...
                            <span className="text-orange-600 dark:text-orange-400">{data?.username || username}</span>
                        </h1>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {data.aiInsights.strengths.map((str, i) => (
                                            <span key={i} className="px-2 py-1 bg-white/50 dark:bg-black/20 rounded text-sm text-orange-900 dark:text-orange-100">
                                                {str}
                                            </span>
                                        ))}
                                    </div>
