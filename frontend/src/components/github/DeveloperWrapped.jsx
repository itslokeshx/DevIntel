...
function calculateNightOwlStats(contributions) {
  ...
  const nightPercentage =
    totalCommits > 0
      ? Math.round((estimatedNightCommits / totalCommits) * 100)
      : 0;
...
export function DeveloperWrapped({
  ...
  const slides = [
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="text-3xl text-center text-white/90 font-semibold">
            commits this year
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="mt-8 bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            <div className="text-center text-white/90">
              You were on fire! Consistent daily contributions throughout the
              month.
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {topLanguages.length > 0 ? (
                  topLanguages.map((lang) => (
                    <span
                      key={lang}
                      className="px-4 py-2 bg-white/20 rounded-full text-white font-semibold"
                    >
                      {lang}
                    </span>
                  ))
      ...
      content: (
        <div className="text-center space-y-6">
          <div className="text-3xl font-bold text-white mb-4">
            Your {displayYear} Developer Story
          </div>
  ...
  return (
    <div
      className="relative overflow-hidden rounded-[20px] p-10 text-white"
