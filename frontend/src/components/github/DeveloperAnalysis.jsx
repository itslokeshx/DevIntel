...
export function DeveloperAnalysis({ metrics, contributions, repositories }) {
    ...
    const radarData = [
        ...
        {
            metric: 'Community',
            value: Math.min((repositories?.reduce((sum, r) => sum + (r.stars || 0), 0) || 0) / 5, 100)
        }
    ];
    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">📊 Developer Analysis</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-semibold text-blue-900 dark:text-blue-300">Activity Pattern</h4>
                    </div>
                    <p className="text-sm text-blue-700 dark:text-blue-400 capitalize">
                        {activityPattern === 'consistent' && '📅 Consistent daily contributions'}
                        {activityPattern === 'burst' && '⚡ Burst activity with intense periods'}
                ...
                >
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-semibold text-purple-900 dark:text-purple-300">Project Focus</h4>
                    </div>
                ...
                >
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-semibold text-green-900 dark:text-green-300">Documentation</h4>
                    </div>
                    <p className="text-sm text-green-700 dark:text-green-400 capitalize">
                        {metrics.documentationHabits === 'excellent' && '⭐ Excellent documentation'}
                        {metrics.documentationHabits === 'good' && '✅ Good documentation'}
                        {metrics.documentationHabits === 'inconsistent' && '⚠️ Inconsistent documentation'}
                ...
                >
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-semibold text-yellow-900 dark:text-yellow-300">Dev Score</h4>
                    </div>
